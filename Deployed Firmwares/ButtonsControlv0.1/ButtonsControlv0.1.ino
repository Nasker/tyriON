...
IPAddress selfIp(192, 168, 1, 36);  //  172, 16, 17, 142//ip de la Fiteensy i port on escoltem
const unsigned int inPort  = 3362;
IPAddress outIp(192, 168, 1, 10); //ip destí i port on enviarem    172, 16, 17, 143
